...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="inline-flex h-9 w-9 items-center justify-center rounded-lg border border-outline bg-surface text-fg-muted transition hover:border-outline-strong hover:text-fg"
    >
      {isDark ? (
        <svg
          viewBox="0 0 24 24"
