...
const PROPS: PropRow[] = [
  {
    ...
    type: "string",
    required: true,
    description: "Wires the `<textarea>` to its `<label>` for accessibility.",
  },
  {
    name: "label",
    type: "string",
      ...
      >
        <div className="max-w-lg">
          ...
          <div className="mt-3 flex items-center justify-between text-xs text-fg-subtle">
            <span>
              Live value mirrored below via a local state hook for demo.
            </span>
            <span className="font-mono">{controlledValue.length} chars</span>
          </div>
          <textarea
        ...
        >
          <header className="mb-5">
            ...
            <p className="mt-1 text-sm text-fg-muted">
              Tell the design system team what you wish a component could do.
            </p>
          </header>
