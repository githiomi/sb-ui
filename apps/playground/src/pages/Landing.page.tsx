        ...
        <div className="bg-canvas">
            ...
            <section className="relative overflow-hidden bg-brand-radial">
                ...
                <div className="relative mx-auto max-w-5xl px-6 py-20 sm:py-24">
                    ...
                    <p className="mt-5 max-w-2xl text-base leading-relaxed text-white/70 sm:text-lg text-balance">
                        A live workbench for building, previewing and
                        stress-testing the atoms, molecules and organisms that
                        power the Uniicy sports-betting experience. Pick a
                        component on the left to see every variant in isolation.
                    </p>
                    ...
                    <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
                        <div className="max-w-2xl">
                            ...
                            <p className="mt-2 text-sm leading-relaxed text-fg-muted">
                                Each card opens a dedicated page where the
                                component is rendered in isolation across its
            ...
            <footer className="border-t border-outline/20 bg-surface">
                <div className="mx-auto flex max-w-5xl flex-col gap-2 px-6 py-8 text-xs text-fg-subtle sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <p>
                        © {new Date().getFullYear()} Uniicy. Internal
                        playground.
                    </p>
                </div>
            </footer>
